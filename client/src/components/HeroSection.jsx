...
const PhoneScreen = ({ title, avatar, children }) => (
  <div className="flex flex-col gap-1.5 h-full">
    <div className="flex items-center justify-between mb-1">
      ...
      <div className="w-[18px] h-[18px] rounded-full bg-white/20 border border-white/30 flex items-center justify-center text-[7px] font-bold text-white">
        {avatar}
      </div>
    </div>
    {children}
...
const PhoneCard = ({ label, value, sub, subColor = "text-emerald-400" }) => (
  <div className="bg-white/[0.07] border border-white/10 rounded-xl p-2">
    <div className="text-[6.5px] uppercase tracking-widest text-white/40 mb-1">
      {label}
    </div>
    ...
    {sub && (
      <div className={`text-[6.5px] mt-1 font-medium ${subColor}`}>{sub}</div>
    )}
  </div>
);
...
const PhoneRow = ({ dot, name, sub, amount, amtColor = "text-white" }) => (
  <div className="flex items-center gap-1.5 bg-white/[0.07] border border-white/10 rounded-lg px-2 py-1.5">
    ...
    <div className="flex-1 min-w-0">
      <div className="text-[7px] font-semibold text-white/85 truncate">
        {name}
      </div>
...
const FloatingBadge = ({ icon, label, value, style }) => (
  <div
    className="absolute z-20 flex items-center gap-2.5 bg-white border border-zinc-200 rounded-2xl px-3.5 py-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.12)] whitespace-nowrap"
    style={style}
  >
    <div className="w-7 h-7 rounded-xl bg-zinc-100 flex items-center justify-center text-base flex-shrink-0 border border-zinc-200">
      {icon}
    </div>
    <div className="leading-tight">
      <div className="text-[9px] text-zinc-400 font-medium tracking-wide uppercase">
        {label}
      </div>
      <div className="text-[12px] font-bold text-zinc-900 tracking-tight">
        {value}
      </div>
    </div>
  </div>
...
const StoreBadge = ({ eyebrow, name, icon }) => (
  <div className="flex items-center gap-2.5 bg-white border-2 border-zinc-900 rounded-xl px-4 py-2.5 shadow-[3px_3px_0_#000] hover:shadow-[1px_1px_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all cursor-pointer">
    {icon}
    <div className="leading-tight">
      <div className="text-[9px] text-zinc-400 uppercase tracking-wide font-medium">
        {eyebrow}
      </div>
...
const PlayIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24">
    <path
      d="M3.18 23.76c.3.17.64.22.97.15l13.18-7.61-2.87-2.87L3.18 23.76z"
      fill="#EA4335"
    />
    <path
      d="M22.12 10.31l-3.03-1.75-3.2 3.2 3.2 3.2 3.05-1.76c.87-.5.87-1.89-.02-2.89z"
      fill="#FBBC05"
    />
    <path
      d="M2.21.24C1.9.42 1.69.76 1.69 1.19v21.62c0 .43.21.77.52.95l12.06-12.06L2.21.24z"
      fill="#4285F4"
    />
    <path
      d="M3.18.24l11.28 11.46 2.87-2.87L4.15.09C3.82.02 3.48.07 3.18.24z"
      fill="#34A853"
    />
  </svg>
);
    ...
    <section className="relative min-h-screen bg-white flex flex-col justify-center overflow-hidden pt-24 pb-16 px-6">
      ...
      >
        ...
        >
          <FloatingBadge
            ...
            style={{
              bottom: 230,
              left: 0,
              animation: "bizezy-float 4s ease-in-out infinite",
            }}
          />
          <FloatingBadge
            icon="↑"
            ...
            style={{
              top: 24,
              right: 0,
              animation: "bizezy-float 4.5s ease-in-out infinite 0.5s",
            }}
          />
          <FloatingBadge
            icon="!"
            ...
            style={{
              bottom: 80,
              right: -10,
              animation: "bizezy-float 3.8s ease-in-out infinite 0.9s",
            }}
          />

          {/* Left phone — Analytics */}
          <div
            className="relative bg-zinc-950 border border-zinc-700/60 overflow-hidden flex-shrink-0 shadow-2xl"
            style={{
              width: 140,
              height: 252,
              borderRadius: 22,
          ...
          <div
            className="relative bg-zinc-950 border border-zinc-600/70 overflow-hidden flex-shrink-0 z-10 mx-3"
            style={{
              width: 168,
              height: 316,
              borderRadius: 26,
        ...
        <div className="flex flex-col items-start text-left order-last lg:order-first">
          ...
          {/* Headline */}
          <h1
            className="text-5xl sm:text-6xl lg:text-[68px] font-black leading-[1.0] mb-5 text-zinc-900"
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.aethonslab.bizezyapp"
              target="_blank"
