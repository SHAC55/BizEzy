...
const PlayStoreIcon = () => (
  ...
  >
    <path
      d="M3.18 23.76c.3.17.64.24.99.19L14.9 12 11.1 8.2 3.18 23.76z"
      fill="#EA4335"
    />
    <path
      d="M20.96 10.27L17.6 8.34 13.5 12l4.1 4.1 3.37-1.93c.96-.55.96-1.45-.01-2z"
      fill="#FBBC04"
    />
    <path
      d="M3.18.24C2.83.46 2.62.86 2.62 1.4v21.2c0 .54.21.95.56 1.16L14.9 12 3.18.24z"
      fill="#34A853"
    />
    <path
      d="M3.18.24L14.9 12l2.7-2.7-12.43-7.13c-.35-.2-.69-.21-.99.07z"
      fill="#4285F4"
    />
  </svg>
);
      ...
      >
        ...
        <div className="relative bg-[#0c1014] rounded-[28px] overflow-hidden px-8 py-16 sm:px-14 sm:py-20 text-center">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 60% 40% at 50% -5%, rgba(255,255,255,0.07) 0%, transparent 65%)",
            }}
          />
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center gap-2 border border-white/[0.12] rounded-full px-4 py-1.5 mb-7">
              ...
              <span className="text-[10px] font-semibold text-white/45 tracking-[0.14em] uppercase">
                Now Live — Launch Offer
              </span>
            </div>
            ...
            <p className="text-[14.5px] text-white/40 leading-[1.75] max-w-[480px] mx-auto mb-9 font-light">
              Join BizEzy to track payments, manage inventory, and grow — all
              from one app.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2.5 mb-10">
              <button className="flex items-center gap-2 bg-white hover:bg-zinc-100 text-[#0c1014] text-[13.5px] font-semibold px-7 py-3.5 rounded-[14px] transition-all duration-200 active:scale-95">
                <Icon
                  d="M12 3v12M7 14l5 5 5-5M3 19h18"
                  size={14}
                  stroke="#0c1014"
                  strokeWidth={2.2}
                />
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              ...
              >
                <div className="flex items-center gap-3 bg-white/[0.05] border border-white/[0.10] hover:bg-white/[0.09] hover:border-white/[0.22] rounded-[14px] px-5 py-3 transition-all cursor-pointer min-w-[160px]">
                  <PlayStoreIcon />
                  <div className="text-left leading-none">
                    <div className="text-[9px] text-white uppercase tracking-[0.06em] mb-1">
                      Get it on
                    </div>
        ...
        {/* Bottom strip */}
        <div
          className={`mt-6 flex flex-wrap justify-center items-center gap-x-8 gap-y-2 pt-5 border-t border-zinc-200 transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"}`}
        >
